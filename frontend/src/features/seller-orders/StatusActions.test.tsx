...
describe('StatusActions', () => {
  ...
  it('offers to advance and to cancel a placed item', () => {
    renderWithProviders(<StatusActions itemId="item-1" status="placed" onChanged={vi.fn()} />)
  ...
  it('hides both actions once delivered', () => {
    renderWithProviders(<StatusActions itemId="item-1" status="delivered" onChanged={vi.fn()} />)
  ...
  it('shows a note instead of the stepper when cancelled', () => {
    renderWithProviders(<StatusActions itemId="item-1" status="cancelled" onChanged={vi.fn()} />)
  ...
  it('advances the status and notifies the parent', async () => {
    ...
    renderWithProviders(<StatusActions itemId="item-1" status="placed" onChanged={onChanged} />)
